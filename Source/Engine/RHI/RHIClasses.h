...
namespace RHI{
	...
	public:
		...
		virtual void End() = 0;
		virtual void BeginRenderPass(RRenderPass* pass, RFramebuffer* framebuffer, const IURect& area) = 0;
		...
		virtual void ClearAttachment(RImageAspectFlags aspect, const float* color, const IURect& rect) = 0;
