...
#define RESOURCE_VK_HANDLE(cls, vkHandle)\
	...
	public:
		...
		void End() override;
		void BeginRenderPass(RRenderPass* pass, RFramebuffer* framebuffer, const IURect& area) override;
		...
		void ClearAttachment(RImageAspectFlags aspect, const float* color, const IURect& rect) override;
